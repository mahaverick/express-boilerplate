...
flushing traces. The timeouts bound each DNS query attempt, each connection
attempt, the greeting and socket inactivity. They are not a per-send
deadline: DNS queries are retried, and a host that resolves to several
