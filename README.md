...
| Script                              | What it does                                                                                                                                                               |
| ----------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `pnpm dev`                          | Runs the app with `tsx watch` (no build step). Loads `.env` itself via `dotenv` — nothing to export by hand, see Quickstart.                                               |
| `pnpm build`                        | `tsc` then `tsc-alias --resolve-full-paths` into `dist/`.                                                                                                                  |
| `pnpm start`                        | Runs the built app: `node dist/index.js`.                                                                                                                                  |
